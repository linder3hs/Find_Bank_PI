...
import com.linder.find_bank.respository.AgenteAllAdapter;
...
public class AgenteAllActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    private RecyclerView agentesListAll;
    private static final String TAG = AgenteAllActivity.class.getSimpleName();
    private SwipeRefreshLayout swipeLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_agente_all);

        //Flecha atras
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        agentesListAll = (RecyclerView) findViewById(R.id.recyclerAll);
        agentesListAll.setLayoutManager(new LinearLayoutManager(this));

        agentesListAll.setAdapter(new AgenteAllAdapter(this));
        swipeLayout = (SwipeRefreshLayout) findViewById(R.id.swipeLayoutAll);
    ...
    private void initialize() {
        ...
        call.enqueue(new Callback<List<Agente>>() {
            ...
            public void onResponse(Call<List<Agente>> call, Response<List<Agente>> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        AgenteAllAdapter adapter = (AgenteAllAdapter) agentesListAll.getAdapter();
                    ...
                    try {
                        ...
                        Toast.makeText(AgenteAllActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                    }catch (Throwable x){}
                }
            }
            ...
            public void onFailure(Call<List<Agente>> call, Throwable t) {
                ...
                Toast.makeText(AgenteAllActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
